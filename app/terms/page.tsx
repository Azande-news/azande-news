  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="prose-article font-body text-ink/90 space-y-5">
        ...
        <h2 className="font-display text-trafalgar font-medium text-ink pt-2">No warranty</h2>
        <p>
        ...
        <h2 className="font-display text-trafalgar font-medium text-ink pt-2">Changes</h2>
        <p>
