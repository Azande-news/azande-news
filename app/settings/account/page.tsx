  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="border border-accent/30 p-5">
        <h2 className="font-display text-trafalgar font-medium text-ink mb-2">Delete my account</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={loading}
                className="bg-ink text-white px-5 py-2.5 text-sm font-medium hover:bg-black transition-colors disabled:opacity-60"
              >
                {loading ? "Deleting…" : "Permanently delete my account"}
              </button>
              <button
                onClick={() => { setStep("initial"); setConfirmText(""); setError(null); }}
                className="px-5 py-2.5 border border-border text-sm font-medium hover:bg-offwhite transition-colors"
              >
                Cancel
              </button>
            </div>
